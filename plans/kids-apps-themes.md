...
- **Bubblegum is the placeholder**: a light pink-and-lilac palette with a generated bubbles background, `Yaru-magenta` icons, a pink keyboard, and the Catppuccin Latte editor themes, complete enough to switch to and easy to replace or rename. The switcher previews its background, since it ships no screenshot.
