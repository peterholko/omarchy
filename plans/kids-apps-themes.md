...
- **Bubblegum is the placeholder**: a light pink-and-lilac palette, `Yaru-magenta` icons, a pink keyboard, and the Catppuccin Latte editor themes, complete enough to switch to and easy to replace or rename. Its first background is a painted dusk over a mountain lake that Peter chose for his daughter (two kids and a Shiba on a ridge, a stag on the far rock), with a generated bubbles image second; the switcher previews the first, since the theme ships no screenshot.
