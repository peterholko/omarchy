...
A child install can make the kid earn her screen time with arithmetic. Turn it on with `sudo omarchy-parent time on`. From then on her time counts down while the screen is unlocked, and when it runs out the screen locks. She unlocks it with her own password, and instead of her desktop she gets _Math time_: a full-screen session of five questions that earns thirty minutes when every answer is right, six minutes per correct answer, up to 120 minutes a day. A wrong answer gets a second try, then the answer is shown and the next question comes. When the session is done she sees how she did, how long it took, and what she has banked, and her desktop is back. She can also open _Math time_ from the Omarchy menu whenever she likes, to bank time before it runs out; the lock screen always shows what she has left.
